"""
   Data-relevant handler: 
        num_classes: predictor output classes (chars for charnn)
...
class LocalDataProcessor(object):
    ...
    characters and generating batches of data.
    """
    def __init__(self, configs, input_url=None, data_dir=None,
        ...
        params:
            ...
            num_classes: the maximum number of character classes
        """
        # logging
    ...
    def prepare_corpus(self, sep="[]"):
        ...
        return:
            corpus: chars in numeric encoding
            idx_to_vocab
            vocab_to_idx
        """
